# GenesysCoin (The Crypto Gaming Currency) - Standard Wallet
TEMPLATE = app
...
contains(RELEASE, 1) {
    ...
    macx:QMAKE_LFLAGS += -mmacosx-version-min=10.9 -arch x86_64 -isysroot /Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk
...
isEmpty(BOOST_LIB_PATH) {
    macx:BOOST_LIB_PATH = /usr/local/boost/1.57.0/lib
}

isEmpty(BOOST_INCLUDE_PATH) {
    macx:BOOST_INCLUDE_PATH = /usr/local/boost/1.57.0/include
}
...
macx:ICON = src/qt/res/icons/gsy.icns
macx:TARGET = "GenesysCoin-Qt"
