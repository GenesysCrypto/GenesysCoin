...
static const int MAX_OUTBOUND_CONNECTIONS = 65;
...
void ThreadGetMyExternalIP(void* parg)
{
    ...
    RenameThread("GenesysCoin-ext-ip");
...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GenesysCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed1", "104.255.33.176"},
	{"seed2", "185.81.166.68"},
	{"seed3", "23.227.190.194"},
	{"seed4", "104.156.233.0"},
	{"seed5", "45.63.18.148"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("GenesysCoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("GenesysCoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("GenesysCoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("GenesysCoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GenesysCoin is probably already running."), addrBind.ToString().c_str());
        else
...
void StartNode(void* parg)
{
    ...
    RenameThread("GenesysCoin-start");
