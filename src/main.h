...
#define START_MASTERNODE_PAYMENTS_TESTNET 1444910400   // Start on Thu, 15 Oct 2015 @ 12PM	GMT
...
static const int LAST_POW_BLOCK = 6220; // Last POW Distribution before going Full DPOS
...
static const int64_t MIN_TX_FEE = 1000; // DO NOT TOUCH
...
#endif
static const uint256 hashGenesisBlock("0x0000004cae24db4855ee1cb43539b3535c8609afbe34df8e701417f1b39bff12");
static const uint256 hashGenesisBlockTestNet("0x0000004cae24db4855ee1cb43539b3535c8609afbe34df8e701417f1b39bff12");
...
public:
    ...
    {
        // GenesysCoin: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // GenesysCoin: get transaction coin age
...
public:
    ...
    // GenesysCoin: block signature - signed by one of the coin base txout[N]'s owner
    std::vector<unsigned char> vchBlockSig;
	
	mutable CScript payee;      /////// mn
    ...
    // GenesysCoin: two types of block: proof-of-work or proof-of-stake
    ...
    // GenesysCoin: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // GenesysCoin: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // GenesysCoin: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // GenesysCoin: block index flags
    enum
    {
...
public:
	...
	bool lookup(uint256 hash, CTransaction& result) const;   ////  mn
