...
if(isAnonymizeOnlyUnlocked())
 ...
 //emit message(tr("Send Coins"), tr("InstantX doesn't support sending values that high yet. Transactions are currently limited to %n GENESYSCOIN.", "", GetSporkValue(SPORK_2_MAX_VALUE)),true, CClientUIInterface::MSG_ERROR);
