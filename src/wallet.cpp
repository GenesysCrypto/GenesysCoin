...
// GenesysCoin: total coins staked (non-spendable until maturity)
...
// GenesysCoin: check 'spent' consistency between wallet and txindex
// GenesysCoin: fix wallet spent state according to txindex
...
// GenesysCoin: disable transaction (only for coinstake)
